...
CREATE TABLE `appointment` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKncums1tsqu7qx1qw5o2g4nj78` (`department_id`),
  ...
  CONSTRAINT `FKncums1tsqu7qx1qw5o2g4nj78` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`),
...
INSERT INTO `appointment` VALUES (5,'2021-09-29','12:00:00',4,7,9),(6,'2021-09-29','11:30:00',4,2,9);
