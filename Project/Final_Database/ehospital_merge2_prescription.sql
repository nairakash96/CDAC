...
CREATE TABLE `prescription` (
  ...
  CONSTRAINT `FK1ppr8greedyrey8nchpr0v4dn` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`),
...
INSERT INTO `prescription` VALUES (3,'Viral Infection ','Tablet : PCM 2 times post meal for 2 days','2021-09-29',2,9);
